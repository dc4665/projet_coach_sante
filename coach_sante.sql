...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 03 mars 2020 à 20:33
...
(1, 'Un corps sain débute par une alimentation saine, cela est un bon début', 'Pour la prochaine séance essaye de monter le rythme tout en restant sur la qualité des mouvements', 'Bonne semaine', 11, 1),
(2, 'Tu continue sur ta lancée', 'Essaye de rester sur cette dynamique', 'Rien a dire', 11, 2);
