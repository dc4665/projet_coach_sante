        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-12 mt-5">
                    <h1 class="big_font responsive_title mt-5">Politique de Confidentialité</h1>
            ...
            <div class="container mt-5">
                <div class="row">
                    <div class="col mt-5 mb-4">
                        ...
                        <h2 class="h3 mt-5 mb-4">Nature des données collectées</h2>
                            <p>
                                Dans le cadre de l'utilisation des Sites, l'Éditeur est susceptible de collecter les catégories de données suivantes concernant ses Utilisateurs : Données d'état-civil, d'identité, d'identification...<br>
                                Données relatives à la vie personnelle (habitudes de vie, situation familiale, hors données sensibles ou dangereuses).<br>
                                Données relatives à la vie professionnelle (CV, scolarité, formation professionnelle, distinctions...). <br>
                                Informations d'ordre économique et financier (revenus, situation financière, situation fiscale...).<br>
                                Données de connexion (adresses IP, journaux d'événements...).<br>
                                Données de localisation (déplacements, données GPS, GSM...)
                            </p>

                        <h2 class="h3 mt-5 mb-4">Agrégation des données</h2>
                            <p>
                        ...
                        <h2 class="h3 mt-5 mb-4">Cookies</h2>
                            <p>
                        ...
                        <h2 class="h3 mt-5 mb-4">Conservation des données techniques</h2>
                            <p>
                                <strong>Durée de conservation des données techniques</strong><br>
                        ...
                        <h2 class="h3 mt-5 mb-4">Délai de conservation des données personnelles et d'anonymisation</h2>
                            <p>
                        ...
                        <h2 class="h3 mt-5 mb-4">Suppression du compte</h2>
                            <p>
                                <strong>Suppression du compte à la demande</strong><br>
                        ...
                        <h2 class="h3 mt-5 mb-4">Modification des CGU et de la politique de confidentialité</h2>
                            <p>
